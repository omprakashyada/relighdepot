            ...
            <div class="sec-sidebar">
               ...
               <section class="all-dashboard">
                  ...
                  <div class="dashboard-wrapper">
                     <div class="block-element">
                        <div class="selct-site stage-replace  upload-seller csv-import">
                           ...
                           <div class="multi-steps-form">
                              <ul id="progressbar-step">
                                 <a href="https://pim.sdiebiz.net/relight/templates.php">
                                 <li class="active"> <span> Choose/Create Template </span></li></a>
                        ...
                        <?php
                           if (isset($_POST['submit'])) {
                              ...
                              $column_count=count($arraykey); 
                              $csv_col=json_encode($arraykey);
                              $column=serialize($arraykey); 

                              //print_r($csv_col);
                              $query="SELECT * FROM `template_csv_data1`  ORDER BY Id DESC LIMIT 1";
                              $res=mysqli_query($conn,$query);
                              $row=mysqli_fetch_assoc($res);
                              $id=$row['Id'];
                              $temp_name=$row['Template_name'];
                              $query1="select * from `template_details` where `Template_id`='$id'";
                              ...
                              <table>
                                 ...
                                 <tr>
                                    ...
                                    <td class="checkbox-row">
                                       ...
                                       <input type="checkbox" name="selection" data-id="<?php echo $k; ?>" class="prod_option_<?php echo  $k;?> selection cat step2" value="<?php  echo  $arraykey[$k];?>"/> 
                                       <input type="checkbox" name="pid" data-id="<?php echo $k; ?>" class="prod_option_<?php echo $k; ?> selection cat" value="<?php echo  $arraykey[$k]; ?>"  style="display:none;"/>
                     ...
                     <div class="records-btn">
                        <form method="GET" action="display_csv.php">
