                     ...
                     <div class="block-element">
                        <div class="selct-site stage-replace  upload-seller display-site">
                           ...
                           <?php
                                ...
                                $temp_id=$_GET['tempid']; 
                                $query="SELECT * FROM `template_attributes` Where Template_id=".$temp_id."";
                                $res=mysqli_query($conn,$query); 
                                $find=mysqli_fetch_assoc($res);
                                $data=unserialize($find['Selected_column']);
                                $data_col=unserialize($find['Column_attributes']);
                                $prefix=$find['Prefix'];
                           ...
                           <div class="table-responsive">
                              <table id='example' class='show-user-table display mapping-n-table  c-scrollbar  mapping-table data_show' style='width:100%'>
                                 <?php
                                    $data_new= $data;
                                    $data_col=$data_col;
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       //   array_push($url_result,$data_new[$i]);
                                       // }   
                                       // if (($handle = fopen('/home/rdevarona/pim.sdiebiz.net/public/relight/csvupload/'."$latest_filename", "r"))
                        ...
                        <?php }?>
                         ...
                         <?php  for($i=0;$i<count($data_col);$i++){ ?>
                        <input type="checkbox" name="keydatacol" checked data-id="<?php echo $i;?>" class="keydata data_<?php echo $i;?>" value="<?php echo $data_col[$i];?>" style="display:none;" />
                        <?php }?>
                        ...
                        <div class="records-btn">
                           <form method="POST" action="">
                            ...
                            <!-- <a href="https://pim.sdiebiz.net/relight/export.php">Downloads</a> -->
                        </div>
                     </div>
...
<?php 
   ...
   //  ($handle = fopen('/home/rdevarona/pim.sdiebiz.net/public/relight/csvupload/'."$latest_filename", "r")
   if (($handle = fopen(__DIR__.'/csvupload/'."$latest_filename", "r")) !== FALSE){      
      $headers = fgetcsv($handle, 1000, ",");
      global $headers;
      $i=0;
   ...
   // echo "<script>window.open('https://pim.sdiebiz.net/relight/export.php','_self');</script>";
