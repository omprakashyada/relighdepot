...
<!-- 
                     ...
                     <div class="download-pdf-sec">
                           <div class="modify">
                              <h2 class="maps-title_exist">Total Number of Discontinued Products:<span><?php echo  $ak_count;?></span></h2> 
                              <div class="pdf-icon"> 
                                 <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                              </div>

                              <!-- <a href="https://pim.sdiebiz.net/relight/akeneo_csv/< ?php echo $nafile; ?>" id="download" class="export-btn"> -->
