               ...
               <section class="all-dashboard">
                  ...
                  <div class="dashboard-wrapper">
                     <div class="block-element">
                        <div class="selct-site stage-replace live-replace-sec stage-c">
                           
                        <!-- <div class="live-replace-btn-sec bck-srch three-secs">
                           ...
                           <div class="back-btn">
                              <a href="https://pim.sdiebiz.net/relight/live_selection.php" class="search_uilast">Back To Search</a>
                           </div>
                        </div> -->
                  ...
                  <div class="show_table_data existing-table ">
                     <table id='example'  class='show-user-table table display table-responsive' style='width:100%'>
                        <thead>
                           <tr>
                              <th>Product ID</th>
                              <th>Product Sku</th>
     ...
     <table id='example' class='show-user-table display table-responsive' style='width:100%'>
      ...
      for ($i = 0; $i < $length_prd && $length_option ; $i++) {
                 ...
                 $curl = curl_init();
                    ...
                    CURLOPT_URL => 'https://api.bigcommerce.com/stores/av4rzyboqm/v3/catalog/products/'.$products[$i].'/options/'.$options[$i],
                  ...
                  $data_var=json_decode($response);
                   ...
                   <?php
                  $sql = "UPDATE live SET display_name='".$option_replace."' WHERE product_id='".$products[$i]."' AND option_id='".$options[$i]."'";
            if ($conn->query($sql) === TRUE) {
            $output.="<div class='message  record-m'> <span class='record-sucess'> Record updated successfully</span></div>";
            } else {
