                     ...
                     <div class="selct-site">
                        <div class="bck-srch three-secs">
                           <?php 
                              ...
                              $query="SELECT * FROM live WHERE display_name='".$option_check."'";
                               $results = $conn->query($query);
                               $num = $results->num_rows;
                               
                              ?>
                           <div class="total-products">
                              <h1 class="number-txt"> Number Of Products:<?php echo $num;  ?></h1>
                           </div>
                           <div class="site-text">
                              <h3>Live Site</h3>
                           </div>
                        ...
                        <div class="product-inner-sec total-products-sec">
                           ...
                           <div class="block-table">
                              <table id='example' class='show-user-table display table-responsive c-scrollbar' style='width:100%'>
                                 ...
                                 <tbody class="tbody">
                                    ...
                                    <tr>
                                       ...
                                       <td><a target="blank" href="https://store-av4rzyboqm.mybigcommerce.com/manage/products/edit/<?php echo $row['product_id'];?>"><?php echo $row['product_id']; ?></a></td>
                              ...
                              <form method="GET" action="https://pim.sdiebiz.net/relight/live_replace.php">
